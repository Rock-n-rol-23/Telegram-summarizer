...
🔥 *Powered by Llama 3\\.1 70B \\- лучшая модель для русского языка\\!*"""
        ...
        await self.send_message(chat_id, welcome_text, "MarkdownV2")
...
*Лимиты:* До 10 запросов в минуту на пользователя"""
        ...
        await self.send_message(chat_id, help_text, "MarkdownV2")
...
📈 *Используйте бота для обработки длинных текстов и статей\\!*"""
        ...
        await self.send_message(chat_id, stats_text, "MarkdownV2")
...
• Время обработки: {processing_time:.1f}с"""
                ...
                await self.send_message(chat_id, response_text, "MarkdownV2")
                ...
                await self.send_message(chat_id, "❌ *Ошибка при обработке текста\\!*\n\nПопробуйте позже или обратитесь к администратору\\.", "MarkdownV2")
