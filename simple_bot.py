...
WELCOME_MESSAGE_HTML = """👋 <b>Привет!</b> Я умный бот-саммаризатор. Превращаю длинные тексты, статьи, видео, книги и аудио в короткие выжимки с ключевыми фактами.

📚 <b>Что я умею:</b>

<b>Тексты и документы:</b>
• 📝 Тексты — выделяю суть и ключевые факты
• 🌐 Веб-статьи — адаптивное резюме по типу контента
• 📄 Документы (PDF, DOCX, TXT) — структурированное саммари

<b>Книги (NEW!):</b>
• 📚 EPUB, FB2, PDF-книги — умное резюме
• 📖 Отдельные промпты для художественной литературы и нон-фикшн
• 🎯 Сюжет, персонажи, идеи, выводы (без спойлеров!)

<b>Медиа:</b>
• ▶️ YouTube (до 2 часов) — субтитры + описание
• 🗣️ Аудио/голосовые — транскрипция + саммари

⚙️ <b>Настройки:</b>
<code>/10</code> <code>/30</code> <code>/50</code> — уровень сжатия (10%/30%/50%)
<code>/help</code> — справка | <code>/stats</code> — статистика

🚀 <b>Начни прямо сейчас:</b> отправь текст, ссылку, документ, книгу или аудио!"""
...
📝 **ТЕКСТЫ И СТАТЬИ:**
• Отправь текст → выжимка с ключевыми фактами
• Ссылка на статью → адаптивное резюме (tutorial, research, news, blog, docs)
• До 3 ссылок за раз

📚 **КНИГИ (NEW!):**
• EPUB, FB2, PDF-книги → умное резюме
• Структура: сюжет, персонажи, идеи, выводы
• Автоопределение художественной литературы / нон-фикшн
• Чанк-обработка для длинных книг

▶️ **YOUTUBE:**
• Отправь ссылку → резюме по субтитрам + описанию
• До 2 часов длительности
• Структурированное содержание с ключевыми моментами

📄 **ДОКУМЕНТЫ:**
• Поддержка: PDF, DOCX, DOC, TXT (до 20MB)
• Автоматическое извлечение текста + OCR
• Выделение ключевых фактов: цифры, даты, имена, решения

🗣️ **АУДИО:**
• Форматы: MP3, WAV, M4A, OGG, FLAC, AAC, OPUS
• До 50MB, ~1 час длительности
• Транскрипция + структурированное саммари
...
• /help → эта справка
• /smart → умная суммаризация (вкл/выкл)
